...
function buildSystemPrompt(persona, profile = {}) {
  ...
  return [
    ...
    `오늘 날짜: ${today}. 현재 2026년이다.`,
    `14. [최신 검색 결과]가 제공되면 반드시 그 정보를 기반으로 답해라. 네가 원래 알던 것과 달라도 검색 결과가 최신이니까 검색 결과를 따라라. 출처는 말하지 말고 아는 것처럼 자연스럽게. 검색 결과가 없으면 "나도 정확히는 모르는데" 하고 넘겨라.`,
    ...
    `4. 카톡처럼 자연스러운 길이로 답해라. 보통 1~3문장이 적당하다. 길게 늘어놓지는 마라.`,
